 ...
 * @entity
 */
class Tx_BlogExample_Tests_Unit_Domain_Model_PersonTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	public function setUp() {
		$this->fixture = new Tx_BlogExample_Domain_Model_Person('jon', 'doe', 'jon.doe@foo.bar');
	}
