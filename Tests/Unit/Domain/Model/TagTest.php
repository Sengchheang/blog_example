 ...
 * @entity
 */
class Tx_BlogExample_Tests_Unit_Domain_Model_TagTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	public function setUp() {
		$this->fixture = new Tx_BlogExample_Domain_Model_Tag();
	}
	...
	public function getNameGetsName() {
		$name = 'foo';
		$this->fixture = new Tx_BlogExample_Domain_Model_Tag($name);
		$this->assertSame(
			$name,
