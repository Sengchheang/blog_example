 ...
 * @entity
 */
class Tx_BlogExample_Tests_Unit_Domain_Model_BlogTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	public function setUp() {
		$this->fixture = new Tx_BlogExample_Domain_Model_Blog();
	}
	...
	public function removeAllPostsRemovesAllPosts() {
		$post = new Tx_BlogExample_Domain_Model_Post();
		$secondPost = new Tx_BlogExample_Domain_Model_Post();
		$this->fixture->addPost($post);
